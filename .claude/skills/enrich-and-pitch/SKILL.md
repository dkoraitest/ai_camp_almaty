...
- ✅ **1 предложение с контрастом/напряжением из их данных** — сразу к диагнозу
- ✅ **Сильные signal-числа из research** — pain-метрики (маржа, конверсия) обязательно
- ✅ **Сильные формулировки** показывают экспертизу: «редкое сочетание сигналов», «узким местом раньше производства»
- ❌ **НЕ церемониальный warmup**: не «хотел поделиться наблюдением», не «увидел и обратил внимание»
